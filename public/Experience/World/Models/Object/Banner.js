...
export default class Banner extends Modular
{
    static asset_name = 'banner'
    ...
    preSetModel(){
        ...
        const boxGeo = new THREE.BoxGeometry(1.5, 7, 1)
        boxGeo.applyMatrix4( new THREE.Matrix4().makeTranslation(0, 3.5, 0) )
